...
read_chunk("./reports/physical-cognitive/seeds-pulmonary/seed-study.R") #This allows knitr to call chunks tagged in the underlying *.R file.
```
...
```{r declare-globals, echo=echoChunks, results='show', message=warningChunk}
```
...
```{r elsa, echo=echoChunks, results='asis', message=FALSE, warning = warningChunk}
```
