...
read_chunk("./reports/physical-physical/forest/forest.R") #This allows knitr to call chunks tagged in the underlying *.R file.
```
...
```{r table-static-focus, echo=echoChunks, message=TRUE, results='asis', eval=TRUE}
```
