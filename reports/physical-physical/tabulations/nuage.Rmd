...
read_chunk("./reports/physical-physical/tabulations/tabulations.R") #This allows knitr to call chunks tagged in the underlying *.R file.
```
...
```{r nuage, echo=echoChunks, results='asis', message=FALSE, warning = FALSE}
```
