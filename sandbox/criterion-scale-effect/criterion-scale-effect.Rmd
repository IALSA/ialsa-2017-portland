...
read_chunk("./sandbox/criterion-scale-effect/criterion-scale-effect.R") 
```
...
# II. Development A
In this report, we are interested to observe the effect of scaling one of the outcomes in a bivariate growth curve model on the model estimation. To that end in one of the studies, MAP, 
