...
# NOTE: `0-parser` should only assemble the catalog. Parse manually.
...
# NOTE: `0-parser` should only assemble the catalog. Parse manually if any of studies estimated manually.
