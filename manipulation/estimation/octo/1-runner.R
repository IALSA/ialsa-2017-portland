...
ls_model_type <- list(
  "a"       = c("age_c80")
  ,"ae"      = c("age_c80","edu_c7")
  ,"aeh"     = c("age_c80","edu_c7","htm_c")
  ,"aehplus" = c("age_c80","edu_c7","htm_c", "smoke","cardio","diabetes")
...
# subset_condition_1 <- "(dementia_ever EQ 1 or dementia_ever EQ 0)"
subset_condition_1 <- "dementia_ever EQ 0"
folder_data        = "./data/unshared/derived/octo-1"
path_prototype     = "./manipulation/estimation/octo/prototype-wide-octo.inp"
folder_output      = "./model-output/physical-cognitive/studies/test/"
