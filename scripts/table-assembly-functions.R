...
# # catalog_wide <- readRDS("./data/shared/derived/pp-spread.rds") # physical-physical track
# catalog_long <- readRDS("./data/shared/derived/pc-spread.rds") # physical-cognitive track
...
# browser()
  if(full_id){
    d2 <- d %>%
      ...
      dplyr::summarize(
        n_models = n()/41 # replace this with a dynamic value
...
# catalog_long %>% serve_slice_model_type(
#   study_name   = "eas"            ,
#   subgroup     = "female"         ,
...
# catalog_long %>% serve_slice_process_a(
#   study_name   = "eas"            ,
#   subgroup     = "female"         ,
#   model_type   = "aehplus"        ,
#   process_a    = "pef"            ,
